  ...
  return (
    <section className="relative bg-dark text-cream rounded-t-[48px] -mt-12 z-10 overflow-hidden">
      <div className="container relative z-10 py-[80px] lg:py-[120px]">
        ...
        {heading && (
          <FadeIn delay={0.1}>
            <h2 className="font-serif text-[36px] md:text-[48px] lg:text-[56px] leading-[95%] tracking-tighter font-light text-cream text-center mb-12 lg:mb-16">
              {heading}
            </h2>
          </FadeIn>
        )}
                ...
                <div className="flex gap-0.5">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg
                      ...
                      height="16"
                      viewBox="0 0 16 16"
                      fill={star <= Math.floor(Number(googleRating)) ? '#FEFFEA' : 'none'}
                      stroke="#FEFFEA"
                      strokeWidth="1"
                    >
